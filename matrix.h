...
class matrix4f
{
  public:
	...
	static matrix4f scale(const vect3f &v) {return scale(v.v[0], v.v[1], v.v[2]);}
    static matrix4f translate(const vect3f &v) {return translate(v.v[0], v.v[1], v.v[2]);}
    static matrix4f shear(const vect3f &v) {return shear(v.v[0], v.v[1], v.v[2]);}
